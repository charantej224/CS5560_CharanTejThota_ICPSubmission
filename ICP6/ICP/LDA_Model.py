...
reviews_df = pd.read_csv('Sheet_1.csv', error_bad_lines=False)
reviews_df['response_text'] = reviews_df['response_text'].astype(str)
...
t1 = time.time()
reviews_df['tokenized_reviews'] = reviews_df['response_text'].apply(apply_all)
t2 = time.time()
...
print(reviews_df.response_text[0])
